...
class TraceContextFilterTest {
    ...
    void setUp() {
        // Setup mock chain
        when(openTelemetry.getTracer("com.digital.wallet.http")).thenReturn(tracer);
    ...
    void constructor_ShouldInitializeTracerFromOpenTelemetry() {
        ...
        when(freshOpenTelemetry.getTracer("com.digital.wallet.http")).thenReturn(tracer);
        ...
        verify(freshOpenTelemetry).getTracer("com.digital.wallet.http");
    }
