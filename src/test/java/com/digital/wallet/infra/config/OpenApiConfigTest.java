...
class OpenApiConfigTest {
    ...
    void shouldCreateCustomOpenApiConfiguration() {
        ...
        assertThat(openAPI.getInfo().getTitle()).isEqualTo("Digital Wallet API");
    ...
    void shouldConfigureApiInfoWithContactDetails() {
        ...
        assertThat(contact.getName()).isEqualTo("Digital Wallet Team");
        assertThat(contact.getEmail()).isEqualTo("api@digitalwallet.com");
        assertThat(contact.getUrl()).isEqualTo("https://developer.digitalwallet.com");
    }
    ...
    void shouldConfigureApiInfoWithLicense() {
        ...
        assertThat(license.getUrl()).isEqualTo("https://digitalwallet.com/terms");
    }
