...
public class OpenApiConfig implements WebMvcConfigurer {
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .contact(new Contact()
                                .name("RecargaPay Team")
                                .email("api@recargapay.com")
                                .url("https://developer.recargapay.com"))
                        .license(new License()
                                .name("Proprietary license")
                                .url("https://recargapay.com/terms")))
                .externalDocs(new ExternalDocumentation()
                        .description("Complete documentation")
                        .url("https://docs.recargapay.com"))
    ...
    public GroupedOpenApi transactionsApi() {
        return GroupedOpenApi.builder()
                .group("transactions")
                .packagesToScan("com.recargapay.wallet.adapter.controllers.v1")
    ...
    public GroupedOpenApi allApisV1() {
        return GroupedOpenApi.builder()
                .group("wallet-v1")
                .packagesToScan("com.recargapay.wallet.adapter.controllers")
                .pathsToMatch("/api/v1/**")
