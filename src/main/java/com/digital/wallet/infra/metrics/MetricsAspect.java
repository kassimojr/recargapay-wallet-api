...
public class MetricsAspect {
     ...
     */
    @Pointcut("execution(* com.digital.wallet.core.usecases.*Deposit*.execute(..)) || " +
              "execution(* com.digital.wallet.core.services.*Deposit*.*(..)) || " +
              "execution(* com.digital.wallet.adapter.*.deposit*(..))")
    public void depositOperation() {}
    
    /**
     * Pointcut that matches withdrawal operation execution methods.
     */
    @Pointcut("execution(* com.digital.wallet.core.usecases.*Withdrawal*.execute(..)) || " +
              "execution(* com.digital.wallet.core.services.*Withdrawal*.*(..)) || " +
              "execution(* com.digital.wallet.adapter.*.withdraw*(..))")
    public void withdrawalOperation() {}
    
    /**
     * Pointcut that matches transfer operation execution methods.
     */
    @Pointcut("execution(* com.digital.wallet.core.usecases.*Transfer*.execute(..)) || " +
              "execution(* com.digital.wallet.core.services.*Transfer*.*(..)) || " +
              "execution(* com.digital.wallet.adapter.*.transfer*(..))")
